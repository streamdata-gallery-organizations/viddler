...
- name: Viddler  API - Api Echo
  x-api-slug: viddler-api-echo-get
...
- name: Viddler  API - Encoding Cancel
  x-api-slug: viddler-encoding-cancel-post
...
- name: Viddler  API - Encoding GetSettings
  x-api-slug: viddler-encoding-getsettings-get
...
- name: Viddler  API - Encoding GetStatus2
  x-api-slug: viddler-encoding-getstatus2-get
...
- name: Viddler  API - Logins Add
  x-api-slug: viddler-logins-add-post
...
- name: Viddler  API - Logins Get
  x-api-slug: viddler-logins-get-get
...
- name: Viddler  API - Logins Update
  x-api-slug: viddler-logins-update-post
...
- name: Viddler  API - Playlists Create
  x-api-slug: viddler-playlists-create-post
...
- name: Viddler  API - Playlists Delete
  x-api-slug: viddler-playlists-delete-post
...
- name: Viddler  API - Playlists List
  x-api-slug: viddler-playlists-list-get
...
- name: Viddler  API - Playlists MoveVideo
  x-api-slug: viddler-playlists-movevideo-get
...
- name: Viddler  API - Resellers GetSubaccounts
  x-api-slug: viddler-resellers-getsubaccounts-get
...
- name: Viddler  API - Users GetPlayerBranding
  x-api-slug: viddler-users-getplayerbranding-get
...
- name: Viddler  API - Users GetProfile
  x-api-slug: viddler-users-getprofile-get
...
- name: Viddler  API - Users GetSettings
  x-api-slug: viddler-users-getsettings-get
...
- name: Viddler  API - Users SetPlayerBranding
  x-api-slug: viddler-users-setplayerbranding-post
...
- name: Viddler  API - Users SetProfile
  x-api-slug: viddler-users-setprofile-get
